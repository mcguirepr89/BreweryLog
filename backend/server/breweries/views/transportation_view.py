...
from breweries.models import Transportation
from breweries.serializers import TransportationSerializer
...
class TransportationViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.action == 'retrieve':
            # For individual brewery retrieval, include public breweries, user's own breweries and shared breweries
