...
from breweries.models import Brewery, Collection
from breweries.serializers import BrewerySerializer, CollectionSerializer
...
class GlobalSearchView(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        results["breweries"] = BrewerySerializer(breweries, many=True).data
