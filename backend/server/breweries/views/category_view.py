...
from breweries.models import Category, Brewery
from breweries.serializers import CategorySerializer
...
class CategoryViewSet(viewsets.ModelViewSet):
    ...
    def categories(self, request):
        """
        Retrieve a list of distinct categories for breweries associated with the current user.
        """
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        # set any breweries with this category to a default category called general before deleting the category, if general does not exist create it for the user
        ...
        Brewery.objects.filter(category=instance).update(category=general_category)
