...
from .models import Brewery, Checklist, ChecklistItem, Collection, Transportation, Note, BreweryImage, Visit, Category, Attachment
...
class BreweryImageAdmin(admin.ModelAdmin):
...
class VisitAdmin(admin.ModelAdmin):
    list_display = ('brewery', 'start_date', 'end_date', 'notes')
...
class CollectionAdmin(admin.ModelAdmin):
    def brewery_count(self, obj):
        return obj.brewery_set.count()

    brewery_count.short_description = 'Brewery Count'

    list_display = ('name', 'user_id', 'brewery_count', 'is_public')
...
admin.site.register(BreweryImage, BreweryImageAdmin)
admin.site.register(Category, CategoryAdmin)
admin.site.register(City, CityAdmin)
admin.site.register(VisitedCity)
admin.site.register(Attachment)

admin.site.site_header = 'BreweryLog Admin'
admin.site.site_title = 'BreweryLog Admin Site'
admin.site.index_title = 'Welcome to BreweryLog Admin Page'
