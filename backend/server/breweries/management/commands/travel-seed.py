...
class Command(BaseCommand):
    help = 'Imports the featured breweries'

    def handle(self, *args, **kwargs):
        User = get_user_model()
        username = input(
            "Enter a username to own the featured breweries: ")
        ...
        for name, location, type_ in breweries:
        ...
        self.stdout.write(self.style.SUCCESS(
            'Successfully inserted featured breweries!'))
